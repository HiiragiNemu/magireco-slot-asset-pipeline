...
from tools.frida_runtime_probe import (
    build_ac0917_gfdirection_presentation_authority as MODULE,
)
...
class Ac0917PresentationAuthorityTests(unittest.TestCase):
    def _build(self, *, bad_layer_hash: bool = False) -> dict:
        with tempfile.TemporaryDirectory() as temp:
            ...
            return MODULE.build_authority(
                ...
                expected_event_ids=("ac0917_001",),
                expected_event_frames={"ac0917_001": 6},
                expected_counts={
                    "event_count": 1,
    ...
    def test_write_outputs_is_immutable_and_hash_binds_all_roles(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual(
                {
                    "AC0917_GFDIRECTION_PRESENTATION_AUTHORITY.json",
